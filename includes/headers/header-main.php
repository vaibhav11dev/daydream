...
?>
<!-- HEADER STICKY TOP -->
<header class="header header-bg <?php echo $header_class; ?>">
	<div class="container">
		...
		<div class="inner-header site-identity">
			...
			if ( function_exists( 'the_custom_logo' ) && $dd_header_logo == 1 ) {
				...
				if ( $dd_blog_title == 1 ) {
					?>
					<div id="blog-title"><a href="<?php echo home_url(); ?>"><?php bloginfo( 'name' ) ?></a></div> 
					<?php
				}
									...
									<div class="search-form-inner">
										<div class="container">
											<div class="row">
												...
												<div class="col-sm-12">
													<input type="text" name="s" placeholder="<?php _e( 'Type &amp; hit enter', 'daydream' ); ?>">
												</div>
											</div>
										</div>
									</div>
