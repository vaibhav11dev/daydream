...
if ( !function_exists( 'daydream_comment_date' ) ):
	...
	function daydream_comment_date() {
		$date	 = '<a href=href="' . esc_url( htmlspecialchars( get_comment_link() ) ) . '" data-toggle="tooltip" title="' . get_comment_date() . '">';
...
if ( !function_exists( 'daydream_comment_link' ) ):
	...
	function daydream_comment_link() {
		...
		$link	 .= '<a rel="bookmark" title="' . __( 'Permalink to this comment', 'daydream' ) . '" href="' . esc_url( get_comment_link() ) . '">';
		$link	 .= apply_filters( 'daydream_comment_link_text', (string) '<i class="dd-icon-link"></i>' );
		$link	 .= '</a></span>';
