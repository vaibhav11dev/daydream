...
if ( get_header_image() ) {
	$daydream_dynamic_css .= '
		.header-bg {	
			...
			background-color: ' . $dd_header_background_color . ';
			background-position: ' . $dd_header_image_background_position . ';
			background-repeat: ' . $dd_header_image_background_repeat . ';
			background-size: ' . $dd_header_image . ';
			box-shadow: none;
		}
		';
}
...
$dd_container_custom_width_px	 = $dd_custom_width_px - 30;

//General - Layout Width
if ( $dd_width_px != "custom" && ( $dd_width_layout == "fixed" ) && !is_page_template( 'fullwidth-fluid.php' ) ) {
	$daydream_dynamic_css .= '
		body {
	width: ' . $dd_width_px . 'px;
	margin: 0 auto;
}
@media (min-width: ' . $dd_width_px . 'px) {
    .container {
        width: ' . $dd_container_width_px . 'px;
    }
}
';
...
';
	...
	$daydream_dynamic_css .= '
body {
	width: ' . $dd_custom_width_px . 'px;
	margin: 0 auto;
}
@media (min-width: ' . $dd_custom_width_px . 'px) {
    .container {
        width: ' . $dd_container_custom_width_px . 'px;
    }
}
';
} elseif ( $dd_width_px == "custom" ) {
...
if ( $daydream_content_top_bottom_padding ) {
	$daydream_dynamic_css .= '
	.p-tb-content {
		padding-top:' . $daydream_content_top_bottom_padding . ';
		padding-bottom:' . $daydream_content_top_bottom_padding . ';
		padding-left: 0;
		padding-right: 0;
}
';
	...
	$daydream_dynamic_css .= '
	.p-tb-content {
		padding-top:' . $dd_content_top_bottom_padding[ 'top' ] . ';
		padding-bottom:' . $dd_content_top_bottom_padding[ 'bottom' ] . ';
		padding-left: 0;
		padding-right: 0;
}
';
...
if ( $daydream_page_title_bar_bg_color ) {
	$daydream_dynamic_css .= '
.titlebar-bg {
	background-color: ' . $daydream_page_title_bar_bg_color . ';
}
';
} elseif ( $dd_pagetitlebar_background_color ) {
	$daydream_dynamic_css .= '
.titlebar-bg {
	background-color: ' . $dd_pagetitlebar_background_color . ';
}
';
}
...
.footer {
	...
	background-position: ' . $dd_footer_background_position . ';
	background-repeat: ' . $dd_footer_background_repeat . ';
	border-bottom: 0;
	background-size: ' . $dd_footer_image . ';
	width: 100%;
}
';
}
...
if ( !empty( $dd_footer_bg_color ) ) {
	$daydream_dynamic_css .= '
.footer {
	background-color: ' . $dd_footer_bg_color . ';
}
';
}
...
.inner-nav > li.submenu-open > a {
	color: ' . $dd_main_menu_hover_font_color . ';
}
.sub-menu li > a {
	color: ' . $dd_sub_menu_font_color . ';
}
.sub-menu li > a:hover, 
.sub-menu li > a:focus, 
.sub-menu li.submenu-open > a {
	color: ' . $dd_sub_menu_hover_font_color . ';
}
';
...
$daydream_dynamic_css		 .= '
.inner-nav > li > a {
	text-transform: ' . $dd_menu_text_transform . ';
	padding-top: ' . $dd_main_menu_padding_top . ';
	padding-bottom: ' . $dd_main_menu_padding_bottom . ';
	padding-left: ' . $dd_main_menu_padding_left . ';
	padding-right: ' . $dd_main_menu_padding_right . ';
}
';
...
.icons-list a:focus,
.icons-list a:hover {
    color: ' . $dd_primary_color . ';
}

.bottom-line:after {
    border-bottom: 2px solid ' . $dd_primary_color . ';
}
...
.btn.btn-base,
.bg-brand {
    background-color: ' . $dd_primary_color . ';
}
...
.btn.btn-base.btn-fade:focus,
.btn.btn-base.btn-fade:hover {
    border-color: ' . $dd_primary_color . ';
}

.owl-page.active span,
.owl-controls-brand .owl-page.active span {
    box-shadow: 0 0 0 3px ' . $dd_primary_color . ';
}
...
.bg-brand-hvr {
    background-color: ' . $dd_secondry_color . ';
}
';
