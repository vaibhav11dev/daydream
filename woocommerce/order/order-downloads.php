...
<section class="woocommerce-order-downloads">
	<?php if ( isset( $show_title ) ) : ?>
		<div class="sec-head-style"><h3 class="text-title"><?php esc_html_e( 'Downloads', 'daydream' ); ?></h3></div>
	<?php endif; ?>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								...
								case 'download-remaining':
									echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'daydream' );
									break;
